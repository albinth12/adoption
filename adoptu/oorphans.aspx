<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="oorphans.aspx.cs" Inherits="adoptu.oorphans" %>
         ...
         <div align="center" class="container">
            ...
            <h4>
             ...
             <asp:GridView ID="gridview" runat="server" Width="70%" CssClass="mygrdContent" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                 ...
                 <Columns>
                     <asp:BoundField DataField="orphid" HeaderText="orphid" SortExpression="orphid"></asp:BoundField>
                     <asp:BoundField DataField="orphname" HeaderText="orphname" SortExpression="orphname"></asp:BoundField>
                     <asp:BoundField DataField="Oid" HeaderText="Oid" SortExpression="Oid"></asp:BoundField>
                     <asp:BoundField DataField="studyin" HeaderText="studyin" SortExpression="studyin"></asp:BoundField>
