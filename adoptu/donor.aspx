<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="donor.aspx.cs" Inherits="adoptu.donor" %>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      ...
      <div class="card card-register mx-5 mt-5">
        <div class="card-header">Register for Donation</div>
        <div class="card-body px-5 ">
            ...
            <div class="w-100 text-center">
                <asp:Button ID="donr" class="btn btn-primary " Text="Donate" runat="server" OnClick="donor_Click"/>
            </div>
            </div>  
          </div>
