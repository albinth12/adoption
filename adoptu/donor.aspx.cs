...
namespace adoptu
{
    ...
    public partial class donor : System.Web.UI.Page
    {
        ...
        {
            //ClientScript.RegisterStartupScript(this.GetType(), "scripts", "<script>alert('Thanks for Donating..')</script>");            // 
        ...
        protected void donor_Click(object sender, EventArgs e)
        {
            ...
            cm.ExecuteNonQuery();
            con.Close();
            Response.Write("<script LANGUAGE='Javascript'>alert('Thanks for Donation..')</script>");
