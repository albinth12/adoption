...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Orphanagehome.aspx.cs" Inherits="adoptu.Orphanagehome" %>
                ...
                <ul class="sidebar navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <span><asp:Label runat="server">Status</span></asp:Label>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="pagesDropdown">                            
                            <a class="dropdown-item" href="Oadopted.aspx">Adopted</a>                           
                            <a class="dropdown-item" href="oorphans.aspx">Orphans</a>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-sm-6 mb-3">
                                <div class="card text-white bg-primary o-hidden h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="mr-5">Adoption Request!</div>
                                    </div>
                                    <a class="card-footer text-white clearfix small z-1" href="orphadoptrequest.aspx">
                            ...
                            <div class="col-xl-3 col-sm-6 mb-3">
                                <div class="card text-white bg-warning o-hidden h-100">
                                    ...
                                    <a class="card-footer text-white clearfix small z-1" href="Oaddmember.aspx">
                                        <span class="float-left">Enter Details</span>
                                        <span class="float-right">
                                            <i class="fas fa-angle-right"></i>
                                        </span>
                                    </a>
